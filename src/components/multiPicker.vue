<template>
  <div id="multiPicker">
    ...
    <div class="content flexSpace bgW">
      <p :class="item.active==true?'item active':'item'" v-for="item,index in arr" @click="addActive(index)" :dd="item.active">
        {{item.name}}</p>
    </div>
  ...
  methods: {
    getData() {
      for (var i in this.arr) {
        ...
        this.arr[i].name = this.arr[i][this.nickName]
